...
import puiiiokiq.anicat.backend.anime.Repository.*;
import puiiiokiq.anicat.backend.anime.models.*;
...
public class AnimeService {
    ...
    private final AnimeNotAllowedCountryRepository animeNotAllowedCountryRepository;
    ...
    public void deleteAnimeWithRelations(Long animeId) {
        ...
        bannerRepository.deleteById(animeId);
    }
    ...
    // 6. Создание записи баннера
    public Long createBannerRecord(Long animeId, String originalFileName) {
        Anime anime = animeRepository.findById(animeId).orElseThrow();
    ...
    public List<String> getBlockedCountries(Long animeId) {
        return animeNotAllowedCountryRepository.findByAnimeId(animeId)
                .stream()
